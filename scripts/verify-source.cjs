...
(async () => {
  ...
  const expectedCurrencies = ["USD","EUR","GBP","JPY","CHF","CAD","AUD","CNH","CNY","HKD","SGD","KRW","INR","IDR","PHP","THB","MYR","VND","TWD","AED","SAR","ILS","TRY","SEK","NOK","DKK","PLN","CZK","ZAR","EGP","NGN","KES","BRL","MXN","ARS","CLP","COP"];
