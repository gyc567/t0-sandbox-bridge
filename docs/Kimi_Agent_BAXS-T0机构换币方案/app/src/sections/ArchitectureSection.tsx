      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="mt-4 text-[var(--text-secondary)] max-w-2xl mx-auto">
            BAXS 作为双重角色（OFI + Provider）与 T-0 Network 深度耦合
            <br />
              ...
              <div className="glass-panel p-6 neon-border">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                  {layer.items.map((item) => (
                    <div
                      key={item.label}
                      className="bg-[rgba(6,10,18,0.6)] rounded-lg p-4 border border-[var(--border-color)] hover:border-[var(--gold)]/30 transition-all group"
                    >
                      <item.icon
        ...
        >
          <div className="glass-panel p-5 flex items-center gap-4">
            ...
            >
              <div
                className="w-3 h-3 rounded-full bg-[var(--green)]"
          ...
          <div className="glass-panel p-5 flex items-center gap-4">
            ...
            >
              <div
                className="w-3 h-3 rounded-full bg-[var(--cyan)]"
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <p className="text-xs text-[var(--text-secondary)] leading-relaxed">
                BAXS 代表下游客户发起 USDT→法币换币请求。客户资金存入 BAXS Global Account， BAXS
                通过 T-0 GetQuote 获取最优汇率，调用 CreatePayment 创建付款， 接收 UpdatePayment
                状态回调。
              </p>
            </div>
            <div className="space-y-2">
              ...
              <p className="text-xs text-[var(--text-secondary)] leading-relaxed">
                ...
                执行法币 disbursement。支持 EUR/USD/CNH/GBP/CAD 多币种兑付。 通过 UpdateQuote
                持续推送报价流。
              </p>
            </div>
          </div>
